...
def search_point(cell_id, api):
    ...
    cell_ids = [ cell_id ]
    timestamps = [0]
    response = api.get_map_objects(latitude =position[0],
                                        longitude = position[1],
                                        since_timestamp_ms = timestamps,
                                        cell_id = cell_ids)
    #print('Response dictionary (get_player): \n\r{}'.format(json.dumps(response, indent=2)))
...
def scan_area(north,south,west,east,api):
    result = []
    # 1.find all ponit to search with the area
...
if __name__ == "__main__":
    ...
    #40.5291593,-74.4344902,15.72z
    #40.5246319,-74.4360838,15.72z
    #scan_area(40.5291593,40.5246319,-74.4344902,-74.4360838,api)
